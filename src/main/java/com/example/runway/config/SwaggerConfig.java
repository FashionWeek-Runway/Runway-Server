...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        Server DevRealServer = new Server("devServer", "https://dev.runway-api.link", "진짜 개발 서버", Collections.emptyList(), Collections.emptyList());
        Server ProdRealServer = new Server("prodServer", "https://prod.runway-api.link", "진짜 배포 서버", Collections.emptyList(), Collections.emptyList());
