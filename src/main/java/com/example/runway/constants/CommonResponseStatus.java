...
public enum CommonResponseStatus {
    ...
    HIJACK_JWT_TOKEN_EXCEPTION(UNAUTHORIZED,"AUTH007","탈취된(로그아웃 된) 토큰입니다 다시 로그인해주세요."),
    INVALID_REFRESH_TOKEN(UNAUTHORIZED,"AUTH009","리프레쉬 토큰이 유효하지 않습니다."),
    ...
    USERS_EXISTS_ID(BAD_REQUEST,"U005","중복된 전화번호입니다."),

    USERS_EXISTS_NICKNAME(BAD_REQUEST,"U006","중복된 닉네임입니다."),

    POST_USERS_EMPTY_NICKNAME(BAD_REQUEST,"U007","닉네임을 입력해주세요."),

    FAILED_TO_LOGIN(BAD_REQUEST, "U008", "로그인에 실패하였습니다."),

    NOT_EXIST_NICKNAME(NOT_FOUND, "U009", "존재하지 않는 닉네임입니다."),
